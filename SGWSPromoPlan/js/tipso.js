...
(function (factory) {
    ...
    var pluginName = "tipso",
      defaults = {
          ...
          background: '#787f91',//'#656c7e', //'#d84e55',//'#55b555',
          titleBackground: '#51586a',//'#8abc90',//'#333333',
          color: '#fff',//'#ffffff', //'#ffffff',
          titleColor: '#fff',//'#ffffff', //'#ffffff',
    ...
    function reposition(thisthat) {
        ...
        switch (obj.settings.position) {
            ...
            case 'top':
                ...
                //console.log('td pos Left :' + $e.offset().left);
                //console.log('td pos Top :' + $e.offset().top);

                pos_left = $e.offset().left - 85;//+ ($e.outerWidth() / 2) - (realHeight(tipso_bubble).width / 2);
                pos_top = $e.offset().top - 30;//- realHeight(tipso_bubble).height - arrow;

                console.log('final pos Left :' + pos_left);
                console.log('final pos Top :' + pos_top);
