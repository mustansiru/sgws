...
(function (h) { "function" === typeof define && define.amd ? define(["jquery"], function (D) { return h(D, window, document) }) : "object" === typeof exports ? module.exports = function (D, I) { D || (D = window); I || (I = "undefined" !== typeof window ? require("jquery") : require("jquery")(D)); return h(I, D, D.document) } : h(jQuery, window, document) })(function (h, D, I, k) {
    ...
    function Ha(a, b, c, d) {
        ...
        }, g = null !== a.searchDelay ? a.searchDelay : "ssp" === y(a) ? 400 : 0, i = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Oa(f, g) : f).bind("keypress.DT", function (a) { if (13 == a.keyCode) return !1 }).attr("aria-controls", c); h(a.nTable).on("search.dt.DT", function (b, c) { clearTimeout(timeout_datatable); timeout_datatable = setTimeout(function () { if (a === c) try { i[0] !== I.activeElement && i.val(e.sSearch) } catch (d) { } }, 1000); });
        return b[0]
...
function InitiateTableWithSearchInHeaderFooter(tblId,rowNo) {
    var title = '';
    if (rowNo > 0) {
        // Setup - add a text input to each header cell
        $('#' + tblId + ' thead tr:eq(' + rowNo + ') th').each(function () {
            title = $('#' + tblId + ' thead tr:eq(' + parseInt(rowNo - 1) + ') th').eq($(this).index()).text();
            $(this).html('<input type="text" class="form-control-table" placeholder="Search" />');
        });
        ...
        table.columns().every(function (index) {
            $('#' + tblId + '_wrapper thead tr:eq(' + rowNo + ') th:eq(' + index + ') input').on('keyup change', function () {
...
function SetRowSelected() {
    $(".dataTable tbody tr").on('click', function (event) {
        $(".dataTable tbody tr td").removeClass('row_selected');
