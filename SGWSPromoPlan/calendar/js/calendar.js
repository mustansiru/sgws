...
(function ($) {
    ...
    Calendar.prototype.navigate = function (where, next) {
        ...
        if (where == 'next') {
            switch (this.options.view) {
                case 'year':
                    ...
                    currentStartDate = new Date(this.options.position.start.getFullYear(), 1, 1);
                    currentEndDate = new Date(this.options.position.start.getFullYear(), 12, 31);
                    break;
                case 'month':
                    to.start.setMonth(this.options.position.start.getMonth() + 1);
                    currentStartDate = new Date(this.options.position.start.getFullYear(), this.options.position.start.getMonth(), 1);
                    currentEndDate = new Date(currentStartDate.getFullYear(), currentStartDate.getMonth() + 1, 0);
                    break;
                case 'week':
                    to.start.setDate(this.options.position.start.getDate() + 7);
                    currentStartDate = new Date(this.options.position.start.getFullYear(), this.options.position.start.getMonth(), this.options.position.start.getDate());
                    currentEndDate = new Date(currentStartDate.getFullYear(), currentStartDate.getMonth(), currentStartDate.getDate() + 6);
                    break;
                case 'day':
                    to.start.setDate(this.options.position.start.getDate() + 1);
                    currentStartDate = new Date(this.options.position.start.getFullYear(), this.options.position.start.getMonth(), this.options.position.start.getDate());
                    currentEndDate = new Date(currentStartDate.getFullYear(), currentStartDate.getMonth(), currentStartDate.getDate());
                    break;
            }
        } else if (where == 'prev') {
            switch (this.options.view) {
        ...
        getEvents(((currentStartDate.getTime() * 10000) + 621355968000000000), ((currentEndDate.getTime() * 10000) + 621355968000000000));
