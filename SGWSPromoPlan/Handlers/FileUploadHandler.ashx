...
public class FileUploadHandler : IHttpAsyncHandler, System.Web.SessionState.IRequiresSessionState
{
    private static readonly FilesDisposition FILES_DISPOSITION = FilesDisposition.Absolute;
    private static readonly string FILES_PATH = System.Web.Hosting.HostingEnvironment.MapPath("~/UploadedFiles");
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else if (context.Request.HttpMethod.ToUpper() == HttpMethods.POST)
        {
            ...
            for (int FileIndex = 0; FileIndex < context.Request.Files.Count; FileIndex++)
            {
                ...
                FileResponseList.Add(CreateFileResponse(context.Request, FileName, File.ContentLength, ErrorMessage));
            }
