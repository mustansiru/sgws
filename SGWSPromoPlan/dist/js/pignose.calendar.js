            ...
            init: function (options) {
                ...
                this.global = {
                    calendarHtml: Helper.Format('<div class="{0} {0}-{4}">\
												<div class="{1}">\
													<a href="#" class="{1}-nav {1}-prev" onclick="return ChangeMonth(0);">\
													...
													<a href="#" class="{1}-nav {1}-next" onclick="return ChangeMonth(1);">\
                ...
                return this.each(function () {
                    ...
                    local.renderer = function () {
                        ...
                        //MonthChange(local.dateManager.year, local.dateManager.month - 1);
