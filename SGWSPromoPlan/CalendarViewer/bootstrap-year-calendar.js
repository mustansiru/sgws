...
(function ($) {
    ...
    Calendar.prototype = {
        ...
        _renderHeader: function () {
            ...
            var prevDiv = $(document.createElement('th'));
            prevDiv.addClass('monthprev');

            // if (this.options.minDate != null && this.options.minDate > new Date(this.options.startYear, this.options.startMonth, 31)) {
            if (this.options.startMonth == 3) {
                prevDiv.addClass('disabled');
            }
            ...
            var prev2YearDiv = $(document.createElement('th'));
            prev2YearDiv.addClass('year-title month-neighbor2 hidden-sm hidden-xs');
            prev2YearDiv.text(this.options.startMonth - 2);

            //if (this.options.minDate != null && this.options.minDate > new Date(this.options.startYear, this.options.startMonth - 2, 31)) {
            if (this.options.startMonth == 4) {
                prev2YearDiv.addClass('disabled');
            }
            ...
            var prevYearDiv = $(document.createElement('th'));
            prevYearDiv.addClass('year-title month-neighbor hidden-xs');
            prevYearDiv.text(this.options.startMonth - 1);

            if (this.options.minDate != null && this.options.minDate > new Date(this.options.startYear, this.options.startMonth - 1, 31)) {
                prevYearDiv.addClass('disabled');
            }
            ...
            var yearDiv = $(document.createElement('th'));
            yearDiv.addClass('year-title');
            yearDiv.text(this.options.startMonth);

            headerTable.append(yearDiv);

            var nextYearDiv = $(document.createElement('th'));
            nextYearDiv.addClass('year-title month-neighbor hidden-xs');
            nextYearDiv.text(this.options.startMonth + 1);

            //if (this.options.maxDate != null && this.options.maxDate < new Date(this.options.startYear, this.options.startMonth + 1, 1)) {
            if (this.options.startMonth == 11) {
                nextYearDiv.addClass('disabled');
            }
            ...
            var next2YearDiv = $(document.createElement('th'));
            next2YearDiv.addClass('year-title month-neighbor2 hidden-sm hidden-xs');
            next2YearDiv.text(this.options.startMonth + 2);

            // if (this.options.maxDate != null && this.options.maxDate < new Date(this.options.startYear, this.options.startMonth + 2, 1)) {
            if (this.options.startMonth == 10) {
                next2YearDiv.addClass('disabled');
            }
            ...
            var nextDiv = $(document.createElement('th'));
            nextDiv.addClass('monthnext');

            if (this.options.maxDate != null && this.options.maxDate < new Date(this.options.startYear, this.options.startMonth, 1)) {
                nextDiv.addClass('disabled');
            }
        ...
        _renderBody: function () {
            ...
            for (var m = this.options.startMonth; m <= this.options.startMonth; m++) {
                /* Container */
                var monthDiv = $(document.createElement('div'));
                monthDiv.addClass('month-container col-md-12');
                monthDiv.attr("monthid", (m + 1));
        ...
        _applyEvents: function () {
            ...
            this.element.find('.month-neighbor, .month-neighbor2').click(function () {
                if (!$(this).hasClass('disabled')) {
                    _this.setMonth(parseInt($(this).text()));
                }
            });

            this.element.find('.calendar-header .monthprev').click(function () {
                if (!$(this).hasClass('disabled')) {
                    _this.element.find('.months-container').animate({ 'margin-left': '100%' }, 100, function () {
                        _this.element.find('.months-container').hide();
                        _this.element.find('.months-container').css('margin-left', '0');
                        setTimeout(function () { _this.setMonth(_this.options.startMonth - 1) }, 50);
                    });
                }
            });

            this.element.find('.calendar-header .monthnext').click(function () {
                if (!$(this).hasClass('disabled')) {
                    _this.element.find('.months-container').animate({ 'margin-left': '-100%' }, 100, function () {
                        _this.element.find('.months-container').hide();
                        _this.element.find('.months-container').css('margin-left', '0');
        ...
        _openContextMenu: function (elt) {
            ...
            for (var i in events) {
                ...
                eventItemContent.addClass('event-content');
        ...
        _renderContextMenuItems: function (parent, items, evt) {
            ...
            for (var i in items) {
                if (!items[i].visible || items[i].visible(evt)) {
                    ...
                    menuItemContent.addClass('event-content');
